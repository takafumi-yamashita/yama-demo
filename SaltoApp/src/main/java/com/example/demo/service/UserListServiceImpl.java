...
public class UserListServiceImpl implements UserListService{
	 ...
	 * @return 検索結果
	 */
	private List<UserInfoSam> findUserInfoByParam(UserSearchInfo dto){
	 ...
	 */
	private List<UserListInfo> toUserListInfos(List<UserInfoSam> userInfos) {
		var userListInfos = new ArrayList<UserListInfo>();
		for (UserInfoSam userInfo : userInfos) {
